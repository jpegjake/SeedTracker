...
export class SeedTrackerService {
  ...
  getPlantTypeData(): Observable<string[]> {
    ...
    return this.http.get<string[]>(this.url + '/api/planttypes');
  }

  getPlantSubTypeData(type: string): Observable<string[]> {
    return this.http.get<string[]>(this.url + '/api/planttypes/' + type);
  }

  public getSeeds(): Observable<SeedTracked[]> {
    return this.http.get<SeedTracked[]>(this.url + '/api/seeds').pipe(map(
      (data)=>{
  ...
  public getSeed(idseeds: Number): Observable<SeedTracked> {
    return this.http.get<SeedTracked>(this.url + '/api/seeds/' + idseeds
      ).pipe(map(
        (data)=>{
          data.qty = +data.qty;
          return data;
  ...
  public editSeed(revised_plant: SeedTracked): Observable<any> {
    return this.http.put(
      this.url + '/api/seeds/' + revised_plant.idseeds,
      revised_plant
    );
  }
  ...
  public deleteSeed(idseeds: number): Observable<any> {
    return this.http.delete(this.url + '/api/seeds/' + idseeds);
  }

  public deleteAllSeeds(): Observable<any> {
    return this.http.delete(this.url + '/api/seeds');
  }
}
